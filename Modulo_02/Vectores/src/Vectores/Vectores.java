public class Vectores {
	public static void main(String[] args) {
		...
		// mismo tipo.
		// Son conocidos como arrays y es habitual llamar matrices a los vectores que
		// trabajan
		// con dos dimensiones.
		...
		// 1. Mediante el uso de dos vectores almacenar 5 notas de un estudiante para
		// calcular
		// el promedio final. Los valores para calcular el promedio se encuentran en un
		// vector aparte que
		...
		// 2. Dado un vector de cinco nombres cambie todas las lectras de los nombres
		// por numeros
