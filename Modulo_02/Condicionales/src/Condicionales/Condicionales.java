...
public class Condicionales {
	...
	public static void main(String[] args) {
		...
		// Evalua una condición que para el correcto funcionamiento retornará un valor booleano.
		...
		// Si la condicion se cumple se ejecuta la sentencia del programa, en caso de no cumplirse
		// se puede hacer otra condicion para que se cicle, marque error y vuelva a solicitar la info
		...
		// BREAK
		// En este ejemplo, pese a que debe iterar 10 veces, el break corta el ciclo en la primera 
		...
		// CONTINUE
		// En este ejemplo el ciclo esta programado para iterar 5 veces, la condicional en el ciclo determina
		// que cuando llegue a la tercera iteracion salte inmediatamente a la siguiente iteracion, por lo cual solo 
		...
		default: diaLaboral = "Tipo de dia invalido";	
		}
